...
from aria_suite.aria_lifecycle.aria_lifecycle_functions import get_aria_life_cycle_datacenter, get_aria_lifecycle_certificate, create_aria_lifecycle_certificate,get_aria_lifecycle_license_keys_by_alias
...
def get_aria_lifecycle_environment_details(*args, **kwargs):
    ...
    license = get_aria_lifecycle_license_keys(aria_lifecycle_ip, product_alias)
