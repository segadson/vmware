...
def get_aria_lifecycle_environment_details(payload, aria_enviorments_name, *args, **kwargs):
    ...
    target_datacenter_response = get_aria_life_cycle_datacenter(aria_lifecycle_ip, target_datacenter)
    target_datacenter = target_datacenter_response['dataCenterName']
